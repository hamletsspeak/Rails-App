...
class HomePagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home_page" do
    assert_difference("HomePage.count") do
      post home_pages_url, params: { home_page: { content: @home_page.content, title: @home_page.title } }
    end
  ...
  test "should update home_page" do
    patch home_page_url(@home_page), params: { home_page: { content: @home_page.content, title: @home_page.title } }
